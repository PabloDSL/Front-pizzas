              ...
              <v-stepper-items>
                  ...
                  <v-stepper-content step="3">
                      <v-card >
                          ...
                          <div>
                              <h1 class="headline mb-0 font-weight-thin">Detalles de la orden</h1>
                              <br>
                              <div>
                                <br>
                                <br> 
                                  <h4 class="font-weight-light">{{element.nombrePizza}}</h4>
                                  <br>
                                  <br>
                                    <v-chip label outline v-if="select=='Chica'">Chica ${{element.precioBase+70}}</v-chip>
                                    <v-chip label outline v-if="select=='Mediana'">Mediana ${{element.precioBase+100}}</v-chip>
                                    <v-chip label outline v-if="select=='Grande'">Grande ${{element.precioBase+140}}</v-chip>

                                  <v-chip label outline >Dirección: {{this.direccion}} </v-chip>
                                  <v-chip label outline>Nombre de cliente: {{name}}</v-chip>
                                  <br>
